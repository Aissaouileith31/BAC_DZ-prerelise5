    ...
    first_frame = Row([
        Container(
            content=Column([
                ...
                ElevatedButton(width=200,height=60,color='white',bgcolor='#F57C00',on_hover=animate_buttons,on_click=go_to_ar_youtube,content=Row(controls=[Image(src_base64=icons[2],width=50,height=50),Text('Arabic',size=20,text_align=TextAlign.CENTER,offset=Offset(0,0))]))
