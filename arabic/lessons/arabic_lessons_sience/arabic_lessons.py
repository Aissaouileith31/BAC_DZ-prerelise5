#note this is the only guid in all app folder for subject use 
#use this guid for all other subkect file
...
def arabic_lessons(page):
    ...
    i = 0
    for link in links:
        #make the app make button for evry link in the db 
        i += 1
            ...
            Container(
                content=ElevatedButton(
                    ...
                    content=Container(
                        content=Stack(
                            [
                                Image(src_base64=icons[17], width=50, height=50, top=5, left=0),
                                Text(
                                    f"lessons in                                                                                                            arabic N:{i}",
                                    size=20,
                                    text_align=TextAlign.CENTER,
                                    offset=Offset(0.0, 0),
                                ),
